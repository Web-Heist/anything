 ...
 */
class Newswave_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    <label>
        ...
        $dropdown_args = wp_parse_args( $this->dropdown_args, array(
            ...
            'show_option_none'  => __( '&mdash; Select &mdash;', 'newswave' ),
            'selected'          => $this->value(),
            'show_option_all'   => '',
            'orderby'           => 'id',
            'order'             => 'ASC',
 ...
 * @see WP_Customize_Control
 */
class Newswave_Radio_Image_Control extends WP_Customize_Control {
...
class Newswave_Checkbox_Multiple extends WP_Customize_Control {
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    // Repeator Info
    class Newswave_Seperator_Control extends WP_Customize_Control {
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    // Repeator Info
    class Newswave_Premium_Notice_Control extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            <span class="customize-control-title">
                <div class="theme-assist-info">
                    ...
                    <span class="theme-assist-label"><?php echo esc_html__('More ','newswave'). esc_html( $this->label ). esc_html__(' Available on Premium Version.', 'newswave' ); ?></span>
                </div>
            </span>
