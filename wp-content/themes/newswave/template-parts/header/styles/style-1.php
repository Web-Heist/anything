            ...
            <?php if (is_active_sidebar('newswave-offcanvas-widget')): ?>
                <div class="site-header-left">
                    <button id="theme-offcanvas-widget-button" class="theme-button theme-button-transparent theme-button-offcanvas">
                        <span class="screen-reader-text"><?php _e('Offcanvas Widget', 'newswave'); ?></span>
                        <span class="toggle-icon"><?php newswave_theme_svg('menu-alt'); ?></span>
                    </button>
                </div>
            <?php endif; ?>
            ...
            <div class="site-header-right">
                ...
                <?php if ($enable_dark_mode && $enable_dark_mode_switcher) : ?>
                    <button id="theme-toggle-mode-button"
                            ...
                            title="<?php _e('Toggle light/dark mode', 'newswave'); ?>" aria-label="auto"
                            aria-live="polite">
