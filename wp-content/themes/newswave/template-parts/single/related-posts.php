...
$related_posts_text = newswave_get_option('related_posts_text');
$no_of_related_posts = absint(newswave_get_option('no_of_related_posts'));
$order = esc_attr(newswave_get_option('related_posts_order'));
$orderby = esc_attr(newswave_get_option('related_posts_orderby'));
