...
$author_posts_text = newswave_get_option('author_posts_text');
$no_of_author_posts = absint(newswave_get_option('no_of_author_posts'));
$order = esc_attr(newswave_get_option('author_posts_order'));
$orderby = esc_attr(newswave_get_option('author_posts_orderby'));
