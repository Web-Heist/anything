...
$enable_copyright = newswave_get_option('enable_copyright');
$enable_footer_nav = newswave_get_option('enable_footer_nav');
$enable_footer_social_nav = newswave_get_option('enable_footer_social_nav');
$enable_footer_credit = newswave_get_option('enable_footer_credit');
            ...
            <div class="theme-author-credit">
                ...
                <?php if($enable_copyright):?>
                    <div class="theme-copyright-info">
                        <?php
                        $copyright_text = newswave_get_option('copyright_text');
                        if($copyright_text):
                            echo wp_kses_post($copyright_text); 
                        endif;
                        $copyright_date_format = newswave_get_option( 'copyright_date_format', 'Y' );
                        ...
                        printf( esc_html__( ' %1$s.', 'newswave' ), $active_theme_textdomain);
                        ?>
                ...
                <?php if($enable_footer_credit): ?>
                    <div class="theme-credit-info">
                        <?php printf(esc_html__('Designed & Developed by %1$s', 'newswave'), '<a href="https://themeinwp.com/" target = "_blank" rel="designer">ThemeinWP Team</a>'); ?>
                    </div>
